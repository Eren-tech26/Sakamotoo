...
DURATION_LIMIT_MIN = 10  # Max song length in mins (consistent, safe value)
...
SUPPORT_CHANNEL = None  # No channel? Keep None (override early string)
...
# Filters and Lists (fixed: BANNED_USERS as set, adminlist/confirmer consistent)
BANNED_USERS = set()  # Empty set for banned users
adminlist = [7774827065]  # List of admin user IDs
lyrical = {}
votemode = {}
autoclean = []
confirmer = 7774827065  # Your main user ID (int, not dict)
...
# Log Group
LOG_GROUP_ID = -1002970645365  # Consistent with LOGGER_ID
